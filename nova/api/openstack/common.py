...
_STATE_MAP = {
    vm_states.ACTIVE: {
        ...
        task_states.RESIZE_PREP: 'RESIZING',
        task_states.RESIZE_MIGRATING: 'RESIZING',
        task_states.RESIZE_MIGRATED: 'RESIZING',
        task_states.RESIZE_FINISH: 'RESIZING',
    },
    vm_states.BUILDING: {
        'default': 'BUILD',
    },
    ...
    vm_states.RESIZED: {
        ...
        task_states.RESIZE_REVERTING: 'REVERTING_RESIZE',
    },
    vm_states.PAUSED: {
        'default': 'PAUSED',
    },
